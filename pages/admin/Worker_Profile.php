                ...
                <div class="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
                    <div class="col-span-4 sm:col-span-3">
                        <div class="bg-gray-700 shadow rounded-lg p-6">
                            ...
                            <div class="flex flex-col">
                                <span
                                    class="text-gray-300 text-sm uppercase font-bold tracking-wider mb-2">Contact</span>
                                <ul>
                    ...
                    <div class="col-span-4 sm:col-span-9">
                        ...
                        <div class=" mt-4 flex flex-wrap gap-4 justify-center">
                            <a href="./tables/Mail_to_Worker.php?id=<?php echo $row['id']; ?>"
                                class="bg-blue-700 hover:bg-blue-600 text-white py-2 px-4 uppercase tracking-wider rounded">Send
                                Email</a>
                                <a href="../Workers/Delete.php?id=<?php echo $row['id']; ?>"
    class="bg-red-700 hover:bg-red-600 text-white py-2 px-4 uppercase tracking-wider rounded">Terminate
    Profile</a>
                        </div>
                    </div>
                </div>
