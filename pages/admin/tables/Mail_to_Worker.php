        ...
        <div class="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
            ...
            <div class="col-span-4 sm:col-span-9">
                <div class="bg-gray-700 shadow rounded-lg px-10 py-4">
                    ...
                    <form action="../../Mail_Service/Send_Worker_Mail.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" id="email" name="fullname" class="hidden w-full bg-gray-800 text-gray-300 border border-gray-600 rounded-lg px-4 py-2 focus:outline-none focus:border-blue-500 mb-4"
                        value="<?php echo $row['fname'].' '.$row['lname']; ?>" readonly>
