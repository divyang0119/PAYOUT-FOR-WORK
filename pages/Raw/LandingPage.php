            ...
            <div class="container mx-auto px-4">
                <div class="flex flex-wrap">
                    <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                        <div
                            class="relative flex flex-col min-w-0 break-words bg-blueGray-600 w-full mb-8 shadow-lg rounded-lg">
                            <div class="px-4 py-5 flex-auto">
                                <div
                                    class="text-white p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-red-400 ">
                                    <i class="fas fa-award"></i>
                                </div>
                                <h6 class="text-xl text-white font-semibold">Awarded Agency</h6>
                    ...
                    <div class="w-full md:w-4/12 px-4 text-center">
                        <div
                            ...
                            <div class="px-4 py-5 flex-auto">
                                ...
                                <h6 class="text-xl text-white font-semibold">Free Revisions</h6>
                                <p class="mt-2 mb-4 text-blueGray-300">
                    ...
                    <div class="pt-6 w-full md:w-4/12 px-4 text-center">
                        <div
                            ...
                            <div class="px-4 py-5 flex-auto">
                                ...
                                <h6 class="text-xl text-white font-semibold">Verified Company</h6>
                                <p class="mt-2 mb-4 text-blueGray-300">
                ...
                <div class="flex flex-wrap items-center mt-32">
                    <div class="w-full md:w-5/12 px-4 mr-auto ml-auto">
                        ...
                        <a href="../index.html" class="font-bold text-blueGray-400 mt-8">Hire Now!</a>
                    </div>
        ...
        <section class="pt-20 pb-48">
            <div class="container mx-auto px-4">
                ...
                <div class="flex flex-wrap">
                    <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                        <div class="px-6">
                            <img alt="..." src="img/Divyang.jpg" 
                                class="shadow-2xl  rounded-lg mx-auto max-w-120-px" />
                    ...
                    <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                        <div class="px-6">
                            <img alt="..." src="img/kaushik.jpg" class="shadow-2xl rounded-lg mx-auto max-w-120-px" />
                            <div class="pt-6 text-center">
                    ...
                    <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                        <div class="px-6">
                            <img alt="..." src="img/brijesh.jpg" class="shadow-2xl rounded-lg mx-auto max-w-120-px" />
                            <div class="pt-6 text-center">
                    ...
                    <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                        <div class="px-6">
                            <img alt="..." src="img/user.png" class="shadow-2xl rounded-lg mx-auto max-w-120-px" />
                            <div class="pt-6 text-center">
