...
if (isset($_POST["appoint"])) {
    ...
    $q1 = "INSERT INTO appointment_history (worker_name, profession, appointment_date, appointment_time, transaction_type) VALUES ('" . $_REQUEST['workerName'] . "', '" . $_REQUEST['profession'] . "', '" . $_REQUEST['appointmentDate'] . "', '" . $_REQUEST['appointmentTime'] . "', '" . $_REQUEST['transactionType'] . "')";
    mysqli_query($con, $q1);

    // Insert into transaction_history table
   
    if ($_REQUEST['transactionType'] != "payAfterWork") {
        $q2 = "INSERT INTO transaction_history (transactionType, cardNumber, expiryDate, cvv) VALUES ('" . $_REQUEST['transactionType'] . "', '" . $_REQUEST['cardNumber'] . "', '" . $_REQUEST['expiryDate'] . "', '" . $_REQUEST['cvv'] . "')";
        mysqli_query($con, $q2);
    }
}
?>
...
<body class="bg-gray-900">
    <div class="container mx-auto mt-10 px-8 py-8 md:w-2/5 sm:w-full lg:w-2/5 sm:mx-auto md:mx-auto bg-gray-800 w-2/5 rounded-lg">
        ...
        <form id="appointmentForm" method="POST" enctype="multipart/form-data" class="space-y-4 text-gray-100">
