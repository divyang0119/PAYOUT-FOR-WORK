      ...
      <div class="container mx-auto px-4 h-full">
        <div class="flex content-center items-center justify-center h-full">
          <div class="w-full lg:w-4/12 px-4">
            <div
              ...
              <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                ...
                <form method="POST" enctype="multipart/form-data">
                  ...
                  <div>
                    <label class="inline-flex items-center cursor-pointer"><a href="#"><span
                        class="ml-2 text-sm font-semibold text-blueGray-600">Forget Password ?</span></a>                        
                      </label>                        
                  </div>
            ...
            <!-- Forget Password and Create a Acount -->
            <!-- <div class="flex flex-wrap mt-6">
              <div class="w-1/2">
                <a href="#pablo" class="text-blueGray-700"><small>Forgot password?</small></a>
              </div>
              <div class="w-1/2 text-right">
                <a href="./register.php" class="text-blueGray-700"><small>Create new account</small></a>
              </div>
            </div> -->
